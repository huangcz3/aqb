...
import com.aqb.cn.pojo.GsonMap;
import com.aqb.cn.pojo.GsonXY;
...
public class HttpRequest {
    ...
    public static void main(String[] args) {
        //发送 GET 请求
        String coords = "103.91736,30.75449";
        String s=HttpRequest.sendGet("http://api.map.baidu.com/geoconv/v1/",
        ...
        Gson gs = new Gson();
        GsonMap gsonMap = gs.fromJson(s, GsonMap.class);
