...
public class ImageHandleHelper {
    ...
    public static void main(String[] args) throws Exception {
        ...
        files[0] = "E:/test/QRCode1/1234567890.jpg";
        files[1] = "E:/test/QRCode2/1176101101.jpg";
        int type = 2;//1  横向拼接， 2 纵向拼接
        String targetFile = "E:/test/QRCode/1176101101.jpg";
     ...
     * srcFile源图片、targetFile截好后图片全名、startAcross 开始截取位置横坐标、StartEndlong开始截图位置纵坐标、width截取的长，hight截取的高
     */
